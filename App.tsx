...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen text-odara-text selection:bg-odara-primary/30">
      ...
      {/* Navigation */}
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-odara-dark/90 backdrop-blur-md border-b border-white/5 py-4' : 'bg-transparent py-6'
          }`}
      >
