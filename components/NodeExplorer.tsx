        ...
        <section id="nodes" className="py-24 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                    ...
                    <div className="flex flex-wrap gap-2 p-1 bg-odara-card border border-white/5 rounded-lg justify-start md:justify-end">
                        {(['Source', 'Transform', 'Target'] as const).map((cat) => (
                            <button
                                key={cat}
                                onClick={() => setActiveCategory(cat)}
                                className={`flex-1 md:flex-none px-4 md:px-6 py-2 rounded-md text-sm font-medium transition-all text-center ${activeCategory === cat
