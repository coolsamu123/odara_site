        ...
        <section id="nodes" className="py-24 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6">
                <div className="text-center mb-12">
                    ...
                    <p className="text-odara-muted max-w-lg mx-auto mb-8">
                        Connect to almost anything. From legacy databases to modern cloud warehouses, Odara speaks your data's language.
                    </p>
                    <div className="inline-flex gap-2 p-1 bg-odara-card border border-white/5 rounded-lg">
                        {(['Source', 'Transform', 'Target'] as const).map((cat) => (
                            <button
                                key={cat}
                                onClick={() => setActiveCategory(cat)}
                                className={`px-6 py-2 rounded-md text-sm font-medium transition-all text-center ${activeCategory === cat
